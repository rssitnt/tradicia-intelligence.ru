...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    details:
      'Система собирает записи звонков, историю чатов и переписку, автоматически очищает данные и приводит их к единому формату. LLM-агенты маркируют сценарии, оценивают тон и соответствие регламентам, дают рекомендации по улучшению. Отчёты формируются в BI-дашборде и отправляются руководителям смен.',
    icon: '🎧',
    tags: ['Omnichannel QA', 'LLM', 'Customer support'],
    metrics: [
