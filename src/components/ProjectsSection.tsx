...
const projectsData: Project[] = [
  {
    ...
    icon: '/cases-white/summary-icon.png',
    metrics: [
  ...
  },
  {
    ...
    icon: '/cases-white/rate-manager-icon-white.png',
    metrics: [
  ...
  },
  {
    ...
    icon: '/cases-white/lead-search-white.png',
    metrics: [
  ...
  },
  {
    ...
    icon: '/cases-white/logo-gen-white.png',
    metrics: [
