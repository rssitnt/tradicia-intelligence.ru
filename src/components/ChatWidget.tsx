  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-5 right-5 z-50 w-16 h-16 rounded-full shadow-lg flex items-center justify-center transition-all duration-200 ${
      ...
      {/* Панель чата */}
      {isOpen && (
        <div className="fixed bottom-24 left-4 right-4 md:left-auto md:right-5 z-50 md:w-96 h-[400px] max-h-[70vh] bg-white rounded-lg shadow-2xl flex flex-col overflow-hidden">
          {/* Заголовок */}
